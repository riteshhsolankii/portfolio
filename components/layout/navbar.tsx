  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-accent text-sm shadow-glow">
            {SITE.initials}
          </span>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="glass absolute inset-x-4 top-20 rounded-2xl p-4 lg:hidden"
          >
